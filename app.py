...
app.config['MYSQL_DATABASE_USER'] = 'msd'
app.config['MYSQL_DATABASE_PASSWORD'] = 'compe281'
app.config['MYSQL_DATABASE_DB'] = 'msd'
app.config['MYSQL_DATABASE_HOST'] = 'msd.ceia8gy26zmm.us-west-2.rds.amazonaws.com'
mysql.init_app(app)
...
def addSensor():
    ...
    cnx.commit()
    #subprocess.Popen(["ssh", "ec2-user@ec2-54-183-210-173.us-west-1.compute.amazonaws.com", "cd /home/ec2-user; sh cscript.sh "+ str(vid) +" > /dev/null &"])
